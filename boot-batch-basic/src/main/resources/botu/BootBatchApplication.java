...
public class BootBatchApplication {
	...
	public static void main(String[] args)
		...
		Log log = LogFactory.getLog(BootBatchApplication.class);

		SpringApplication app = new SpringApplication(BootBatchApplication.class);
		...
		if (ADD_NEW_PODCAST_JOB.equals(args[0])) {
			...
			JobParameters jobParameters = new JobParametersBuilder().addDate("date", new Date())
					.addString("updateFrequency", args[1]).toJobParameters();
